        ...
        <?php
           ...
           /* var_dump($_FILES['arquivo']);
            ...
            try{
                ...
                $query = "INSERT INTO cliente (nome,sobrenome,sexo,cpf,endereco,telefone,email) VALUES (:nome,:sobrenome,:sexo,:cpf,:endereco,:telefone,:email)";
                ...
                print("<a href='index.php'>Voltar a lista</a>");
